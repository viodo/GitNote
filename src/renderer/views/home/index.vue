<template>
    <div class="home">
        <div class="list">
            <div class="list-hd drag">
                <i class="list-back el-icon-plus no-drag" @click="pathBack"></i>
                <el-input class="no-drag" v-model="searchText" placeholder="搜索..."
                          prefix-icon="el-icon-search"></el-input>
                <el-dropdown trigger="click" class="list-setting no-drag">
            ...
            <div class="item-num drag" @click="init">总共 1 项</div>
        </div>
        <div class="note-container">
            <div class="hd drag">
                <el-input class="title no-drag" v-model="title" placeholder="无标题笔记"></el-input>
